#!/usr/bin/env python3
"""Generate REAL PAMSR for a single image to avoid GPU OOM."""
import sys, gc
...
GT_COLORS = {3: (255, 80, 80), 4: (80, 120, 255), 5: (60, 200, 60), 6: (255, 160, 30)}

STEM = "2022-06-10-14-34-55-71733"
INFO = "GT=61, rescued=1, FN 7→6"
...
def main():
    ...
    print(f"{STEM}: GT={len(gt_masks)} cells")
    ...
    panel, rc = make_panel(img, gt_masks, gt_cids, single_masks, pamsr_masks, INFO)
